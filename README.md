...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/flask-security-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/flask-security-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add flask-security
# for installing globally
pixi global install flask-security
```
...
It is possible to list all of the versions of `flask-security` available on your platform:
...
```
pixi search flask-security --channel conda-forge
```
